...
export interface PatientAddEditDialogueProps { 
    open: boolean; 
    onClose: () => void; 
    isEdit: boolean; 
}

const PatientAddEditDialogue : React.FC<PatientAddEditDialogueProps> = ({ open, onClose, isEdit }) => {
    const dispatch = useDispatch();
    console.log("PatientAddEditDialogue isEdit", isEdit);
    ...
    return (
        ...
        <RightSideModal open={open} onClose={onClose}>
                <Box sx={{ p: 1, borderBottom: '1px solid', borderColor: 'divider' }}>
                    {/*  */}
                    <Typography variant='h4'>{isEdit ? "Edit Patient" : "Add Patient"} </Typography>
                </Box>
...
export default PatientAddEditDialogue;